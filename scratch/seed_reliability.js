...
async function seed() {
    ...
    try {
        ...
        for (let i = 0; i < 30; i++) {
            ...
            await pool.query(
                'INSERT INTO trip_status_updates (schedule_id, trip_date, status, delay_minutes, updated_at) VALUES ($1, (CURRENT_DATE - ($2 || \' days\')::INTERVAL)::DATE, $3, $4, NOW() - ($5 || \' days\')::INTERVAL)',
                [6, i, status, delay, i]
            );
        }
